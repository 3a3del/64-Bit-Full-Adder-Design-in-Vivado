...
HD_PWD='C:/Users/hp/Universal/Universal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Universal_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Universal_wrapper.tcl -notrace
