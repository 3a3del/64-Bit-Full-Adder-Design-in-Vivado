...
HD_PWD='C:/Users/hp/Universal/Universal.runs/Universal_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Universal_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Universal_ila_0_0.tcl
