...
HD_PWD='C:/Users/hp/Universal/Universal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Universal_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Universal_wrapper.tcl
